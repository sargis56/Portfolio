...
{
    public partial class GamesPage_101 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            GameInformation oneBoneInfo;
            oneBoneInfo = DatabaseConnection.GetGameInfo(101);
        ...
        {
            ErrorURL.GetError = "AmazonFightersDemo00010Install.exe";
