<%@ Page Title="" Language="C#" MasterPageFile="~/FrontPage.Master" AutoEventWireup="true" CodeBehind="GamesPage_100.aspx.cs" Inherits="JollyRogersOfficialWebsite.GamesPage_OneBone" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>ONE BONE | Games Page - We Are JOLLY ROGERS</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="FrontPageContent" runat="server">
    ...
    <table border="1">
        <tr>
            <td colspan="2" rowspan="2" class="gameBoxArtCover"><asp:Image runat="server" ID="boxArt" ImageUrl="~/Images/Mini2.png" /></td>
