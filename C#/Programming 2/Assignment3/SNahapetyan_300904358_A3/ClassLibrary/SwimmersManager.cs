...
using System.IO;
// shortcut to extact interface is: ctrl + r + i
namespace ClassLibrary
{
    public class SwimmersManager : ISwimmersRepository
    {
        ...
        public void Add(Registrant aSwimmer)
        {
            ...
            {
                if ((swimmers[i].RegistNum == aSwimmer.RegistNum) && (swimmers[i].RegistNum != 0))
                {
                    countMatchs++;
        ...
        public void Load(string fileName, string delimiter)
        {
            ...
            while (recordIn != null)
            {
                ...
                try
                {
                    ...
                    {
                        Add(new Registrant(regNum, fields[1], dateTime, new Address(fields[3], fields[4], fields[5], fields[6]), phoneNum, fields[8]));
                    }
